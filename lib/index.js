...
exports.init = (sequelize, optionsArg) => {
	...
	function createBeforeHook(operation) {
      ...
      if (options.metaDataFields) {
        ...
        var requiredFields = _.keys(_.pickBy(options.metaDataFields, function (required) {
          return required;
        }));
        if (requiredFields && requiredFields.length) {
          var metaData = ns && ns.get(options.metaDataContinuationKey) || opt['metaData'];
	...
	function createAfterHook(operation) {
        ...
        if (options.metaDataFields) {
          var metaData = ns && ns.get(options.metaDataContinuationKey) || opt['metaData'];
          if (metaData) {
            _.forEach(options.metaDataFields, function (required, field) {
