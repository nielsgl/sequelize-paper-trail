...
| `PRD-002 WI-001` | `PRD-002` | `WI-001` | Node >=20 enforcement design and impact checklist | 3 | `PRD-002 WI-006` | In Progress |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `PRD-002 WI-001` | Node >=20 enforcement design and impact checklist | `codex` | `codex/prd-002-wi-001-node-gte20-enforcement-design` | `/Users/niels.van.Galen.last/code/sequelize-paper-trail/.worktrees/prd-002-wi-001` | `docs/impl/PRD-002/WI-001-node-gte20-enforcement-design.md` | `approved` | `active` | `codex` | `claim-prd-002-wi-001-20260223t153616z` | `2026-02-23T15:36:16Z` | `PRD-002 WI-006` | `Planning-path trace: plan-mode.` |
